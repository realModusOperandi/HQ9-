...
It is an interactive interpreter that translates commands in to the Java programming language. Which are then translated to Java bytecode. Which are then translated to assembly. Which are then translated to machine code. Which are then translated to electricity. Which is then translated to heat.
